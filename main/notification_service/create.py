...
from .send_messsage import send_message


@receiver(post_save, sender=Mailing_List, dispatch_uid="create_message")
def create_message(sender, instance, created, **kwargs):
    if created:
        mailing = Mailing_List.objects.filter(id=instance.id).first()
